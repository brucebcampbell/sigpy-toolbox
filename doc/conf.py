...
# -*- coding: utf-8 -*-
#
# sigpy documentation build configuration file, created by
...
latex_documents = [
  ('index', 'sigpy.tex', 'sigpy Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'sigpy', 'sigpy Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'sigpy', 'sigpy Documentation',
   'Ariel Rokem', 'sigpy', 'One line description of project.',
   'Miscellaneous'),
]
