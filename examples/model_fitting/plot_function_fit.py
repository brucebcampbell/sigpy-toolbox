"""
================================
Fitting a function with sigpy
================================

sigpy contains a number of tools for fitting functions to
data. This example shows us how to load data into python, fit
a function to our datapoints with sigpy, and then plot the
result.
...
# ------------
#
# First, we'll load some data into sigpy.
...
# ---------------
#
# With sigpy, models are created with the :ref:Model class.
